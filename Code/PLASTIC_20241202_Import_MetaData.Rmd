...
bookdown::html_document2:
    ...
    toc_depth: 6
    fig_caption: yes
bibliography: ../Docs/RPackageCitations.bib
...
# Acknowledgements {-}
This R markdown file was created by Mireille Savoie and Douglas A. Campbell, and was adapted to meet the requirements of the Plastic Degradation term project for BIOL3111 in 2024, using the `FileImportFunctions.Rmd` file created by Douglas Campbell and Carlie Barnhill.
