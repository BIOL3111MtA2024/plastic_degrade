...
TargetDataMeta %>% 
  ...
  geom_vline(aes(xintercept = 4 * 24), 
             linetype = "dashed") +
  geom_vline(aes(xintercept = 11 * 24), 
             linetype = "dashed") + 
  geom_vline(aes(xintercept = 18 * 24), 
             linetype =  "dashed") + 
  geom_vline(aes(xintercept = 25 * 24), 
             linetype =  "dashed") +
  geom_vline(aes(xintercept = 32 * 24), 
             linetype = "dashed") +
