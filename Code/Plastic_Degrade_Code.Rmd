...
```{r}
# Run ANOVA to test if degradation differs by plastic, nutrient, and culture presence
anova_result <- aov(perc_change ~ Plastic_Present * Nutrient_Present * Culture_Present, data = plastic_clean)
