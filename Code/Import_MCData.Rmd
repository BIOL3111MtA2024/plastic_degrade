...
I will be running an ANOVA on '% change in plastic weight' data for experimental groups
...
```{r}
filtered_data<-CultureCatalog[CultureCatalog$Control_or_Replicate != "Control",]

filtered_data$Temperature_C<-as.factor(filtered_data$Temperature_C)

temp_15<-filtered_data[filtered_data$Temperature_C=="15"]
temp_25<-filtered_data[filtered_data$Temperature_C==" 25"]

ttest15<-t.test(temp_15$Initial_Plastic_Weight_mg, temp_15$Final_Plastic_Weight_mg, paired = TRUE, na.rm = TRUE)
ttest25<-t.test(temp_25$Initial_Plastic_Weight_mg, temp_25$Final_Plastic_Weight_mg, paired = TRUE, na.rm = TRUE)
